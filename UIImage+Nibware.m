...
#import "UIImage+Nibware.h"


static inline double radians (double degrees) {return degrees * M_PI/180;}


@implementation UIImage (Nibware)

- (UIImage *)scaleAndRotateImage:(NSInteger)kMaxResolution
{
    return [self scaleAndRotateImage:kMaxResolution withSubrect:CGRectNull];
}
...
- (UIImage *)scaleAndRotateImage:(NSInteger)kMaxResolution withSubrect:(CGRect)subRect
{
    ...
    if (scaleRatio >= 1.0 && orient == UIImageOrientationUp) {
        NSLog(@"UIImage+NibWare: image needs neither resizing nor scaling down, returning original");
